                    ...
                    <div class="card-body p-0">
                        <form action="/register" method="post">
                            ...
                            <div class="p-5">
                                ...
                                <div class="form-group">
                                    <textarea cols="30" rows="4" class="form-control @error('description') is-invalid @enderror"
                                        placeholder="Description" required name="description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
